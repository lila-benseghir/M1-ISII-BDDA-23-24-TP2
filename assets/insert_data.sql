...
insert into chercheur values (1,'salim ahmed','M','LSI','USTHB','');
insert into chercheur values (2,'karim abed','M','LGP','UMBB','');
insert into chercheur values (3,'salima harrath','F','LMA','USDB','');
insert into chercheur values (4,'karima mahi','F','LSI','UAT','');
insert into chercheur values (5,'said khalef','M','LIA','ESI','');
insert into chercheur values (6,'hichem labed','M','LIA','USTHB','');
insert into chercheur values (7,'souad khadem','F','LMA','UAT','');
insert into chercheur values (8,'rafik bradi','M','LGP','ESI','');
